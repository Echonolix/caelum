                            ...
                            PropertySpec.builder("nativeType", NativeType::class)
                                ...
                                .getter(
                                    FunSpec.getterBuilder()
                                        .addStatement("return %T", CBasicType.int32_t.ktffiNativeTypeName)
                                        .build()
                                )
                                .build()
                        )
                    ...
                    TypeSpec.interfaceBuilder(VKFFI.vkFlags64CNAME)
                        ...
                        .addProperty(
                            PropertySpec.builder("nativeType", NativeType::class)
                                ...
                                .getter(
                                    FunSpec.getterBuilder()
                                        .addStatement("return %T", CBasicType.int64_t.ktffiNativeTypeName)
                                        .build()
                                )
                                .build()
                        )
    ...
    private fun TypeSpec.Builder.addCompanionSuper(enumBase: CType.EnumBase) {
        ...
        addSuperinterface(
            ...
            CodeBlock.of(
                ...
                enumBase.baseType.ktffiNativeTypeName,
