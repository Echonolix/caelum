...
class ImplLookupGetter {
    ...
    private static MemorySegment getStaticFieldId(Arena arena, MemorySegment env, MemorySegment clazz, String name, String sig) throws Throwable {
    ...
    private static MemorySegment getStaticObjectField(Arena arena, MemorySegment env, MemorySegment clazz, MemorySegment fieldId) throws Throwable {
    ...
    private static MemorySegment setStaticObjectField(Arena arena, MemorySegment env, MemorySegment clazz, MemorySegment fieldId, MemorySegment obj) throws Throwable {
    ...
    private static MemorySegment getStaticMethodId(Arena arena, MemorySegment env, MemorySegment clazz, String name, String sig) throws Throwable {
    ...
    private static MemorySegment callStaticObjectMethod(Arena arena, MemorySegment env, MemorySegment clazz, MemorySegment methodId, Object... args) throws Throwable {
    ...
    private static MemorySegment getMethodId(Arena arena, MemorySegment env, MemorySegment clazz, String name, String sig) throws Throwable {
    ...
    private static MemorySegment callObjectMethod(Arena arena, MemorySegment env, MemorySegment object, MemorySegment methodId, Object... args) throws Throwable {
